...
namespace UnityAware
{
    ...
    public class BasicInstaller : ScriptableObjectInstaller<BasicInstaller>
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<EntityLink>().FromComponentSibling().AsTransient();
            Container.Bind<IAdjustable>().FromComponentSibling().AsTransient();
            Container.Bind<NavMeshObstacle>().FromComponentSibling().AsTransient();
